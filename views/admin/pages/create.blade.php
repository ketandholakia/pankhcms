    ...
    <form id="page-form" action="/admin/pages" method="POST" class="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4">
        ...
        <div class="mb-4">
          ...
          <div class="flex items-center gap-2">
            <input class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline flex-1" id="featured_image" name="featured_image" type="text" placeholder="/uploads/media/your-image.jpg" value="{{ $old['featured_image'] ?? '' }}">
            <input type="hidden" id="featured_image_persist" name="featured_image_persist" value="{{ $old['featured_image'] ?? '' }}">
        ...
        <div class="mt-3">
          ...
          <div class="mb-6 flex gap-4">
            ...
            <div class="flex-1" id="publish-at-wrap">
                ...
                <input type="datetime-local" name="published_at" id="page-published-at" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" value="">
